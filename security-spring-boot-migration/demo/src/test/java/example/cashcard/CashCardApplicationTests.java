...
class CashCardApplicationTests {
    ...
    void shouldCreateANewCashCard() throws URISyntaxException {
        ...
        RequestEntity<CashCard> req = new RequestEntity<>(newCashCard, headers, HttpMethod.POST, new URI("/cashcards"));
    ...
    private HttpHeaders createClientCsrfHeaders() {
        HttpCookie cookie = new java.net.HttpCookie("XSRF-TOKEN", "some-value");
